...
import shaded.com.fasterxml.jackson.databind.type.HierarchicType;
...
{    
    ...
    public void testCanonicalNames()
    {
        ...
        can = t.toCanonical();
        assertEquals("java.util.EnumMap<shaded.com.fasterxml.jackson.databind.type.TestTypeFactory$EnumForCanonical,java.lang.String>",
                can);
        assertEquals(t, tf.constructFromCanonical(can));
