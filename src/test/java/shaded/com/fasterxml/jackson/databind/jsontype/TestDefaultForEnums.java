    ...
    extends BaseMapTest
{
    ...
    public void testSimpleEnumsInObjectArray() throws Exception
    {
        ...
        assertEquals("[[\"shaded.com.fasterxml.jackson.databind.jsontype.TestDefaultForEnums$TestEnum\",\"A\"]]", json);
    ...
    public void testSimpleEnumsAsField() throws Exception
    {
        ...
        assertEquals("{\"value\":[\"shaded.com.fasterxml.jackson.databind.jsontype.TestDefaultForEnums$TestEnum\",\"B\"]}", json);
