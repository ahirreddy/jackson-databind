 ...
 * {@link shaded.com.fasterxml.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link shaded.com.fasterxml.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     */
...
//            TypeSerializer typeSer = new TypeSerializerWrapper(typeSer0, bean);
        ...
        throws JsonMappingException
    {
        ...
        return shaded.com.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }
