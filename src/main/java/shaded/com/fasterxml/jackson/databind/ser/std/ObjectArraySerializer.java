...
import shaded.com.fasterxml.jackson.databind.jsonFormatVisitors.JsonArrayFormatVisitor;
...
import shaded.com.fasterxml.jackson.databind.ser.ContainerSerializer;
import shaded.com.fasterxml.jackson.databind.ser.ContextualSerializer;
        ...
        if (typeHint != null) {
            ...
            if (javaType.isArrayType()) {
                ...
                if (componentType == Object.class) {
                    o.put("items", shaded.com.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode());
                } else {
                    JsonSerializer<Object> ser = provider.findValueSerializer(componentType, _property);
                    JsonNode schemaNode = (ser instanceof SchemaAware) ?
                            ((SchemaAware) ser).getSchema(provider, null) :
                            	shaded.com.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
