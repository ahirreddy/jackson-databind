...
import shaded.com.fasterxml.jackson.databind.cfg.ConfigFeature;
...
public enum SerializationFeature implements ConfigFeature
{
     ...
     * printer (see
     * {@link shaded.com.fasterxml.jackson.core.JsonGenerator#useDefaultPrettyPrinter}
     * for details).
     *<p>
     * Note that this only affects cases where
     * {@link shaded.com.fasterxml.jackson.core.JsonGenerator}
	 ...
	 * in conjunction with {@link shaded.com.fasterxml.jackson.annotation.JsonUnwrapped}.
     ...
     * {@link shaded.com.fasterxml.jackson.databind.SerializationConfig#getDateFormat}:
     * the default setting being {@link shaded.com.fasterxml.jackson.databind.util.StdDateFormat},
     ...
     * {@link shaded.com.fasterxml.jackson.core.JsonGenerator#writeNumber(String)}
     * ot may cause compatibility problems since not all {@link shaded.com.fasterxml.jackson.core.JsonGenerator}
