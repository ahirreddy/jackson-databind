...
public class OptionalHandlerFactory implements java.io.Serializable
{
    ...
    private final static String SERIALIZERS_FOR_JAVAX_XML = "shaded.com.fasterxml.jackson.databind.ext.CoreXMLSerializers";
    private final static String DESERIALIZERS_FOR_JAVAX_XML = "shaded.com.fasterxml.jackson.databind.ext.CoreXMLDeserializers";
    ...
    private final static String SERIALIZER_FOR_DOM_NODE = "shaded.com.fasterxml.jackson.databind.ext.DOMSerializer";
    private final static String DESERIALIZER_FOR_DOM_DOCUMENT = "shaded.com.fasterxml.jackson.databind.ext.DOMDeserializer$DocumentDeserializer";
    private final static String DESERIALIZER_FOR_DOM_NODE = "shaded.com.fasterxml.jackson.databind.ext.DOMDeserializer$NodeDeserializer";
